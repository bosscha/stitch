...
N_STARS = 5000
DIM = 4          # Number of spatial dimensions
...
plt.legend()
plt.grid(True)
plot_filename = 'escaped_stars_4D.png'
...
plt.legend()
plt.grid(True)
plot_rad_filename = 'radial_distribution_4D.png'
...
plt.legend()
plt.grid(True)
plot_dens_filename = 'radial_density_4D.png'
...
plt.legend()
plt.grid(True)
plot_slope_filename = 'mass_slope_evolution_4D.png'
